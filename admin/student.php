...
<?php include_once "sidebar.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
					...
					<form role="form" method="post" action="function/teacher.php">
						<div class="col-md-6">
							...
							<div class="form-group has-success">
								<label>Class</label>
								<input class="form-control" type="text"  placeholder="Class" name="sclass">
							</div>
							<div class="form-group has-success">
								<label>Mobile</label>
						...
						<div class="col-md-6">
							<div class="form-group has-success">
								...
								<input class="form-control" type="text"  placeholder="id" name="regno">
							</div>
							<div class="form-group has-success">
								<label>Subject</label>
								<input class="form-control" type="text"  placeholder="subject" name="section">
							</div>
							<div class="form-group has-success">
								<label>E-mail</label>
