					...
					<form role="form" method="post" action="function/teacher.php">
						...
						<div class="col-md-6">
							<div class="form-group has-success">
								...
								<input class="form-control"  type="text" placeholder="id" name="staffid">
							</div>
							<div class="form-group has-success">
								<label>Subject</label>
				...
				<div class="panel panel-default">
					...
					<table class="table table-hover" id="myTable"> 
                         <thead> 
                            ...
                            <tbody> 
                            <?php
                                $sql = "SELECT *  FROM teacher_details WHERE status='1'";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    ?>
                                        <tr> 
                                            ...
                                            <td> <a href="function/removeuser.php?removetid=<?php echo $id;?>">Delete</a></td> 
