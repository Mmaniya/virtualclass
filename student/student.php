					...
					<div class="panel-body timeline-container">
						<ul class="timeline">
							...
							<li>
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4 class="timeline-title">Rigister Number</h4>
									</div>
									<div class="timeline-body">
										<p><?php echo $regno;?></p>
									</div>
							...
							<li>
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4 class="timeline-title">E-Mail</h4>
									</div>
									<div class="timeline-body">
										<p><?php echo $parent_email;?></p>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4 class="timeline-title">Mobile</h4>
									</div>
									<div class="timeline-body">
										<p><?php echo $parent_contact_no;?></p>
									</div>
								</div>
							</li>
						</ul>
			...
			<div class="col-md-6">
				<div class="panel panel-default chat">
					...
					<div class="panel-body">
						<img src='assets/image/images.jpeg' width=100% >
					</div>
